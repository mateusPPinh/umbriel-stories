  ...
  const renderArticleSkeleton = (
    ...
    return (
      <div className="flex flex-col gap-2">
        <div
          className={`${aspectRatio} rounded ${
            isDarkTheme ? 'bg-gray-700/50' : 'bg-gray-200/50'
          } w-full`}
        />
                          ...
                          article.content?.description && (
                            <p
                              ...
                              style={{
                                ...
                                fontSize:
                                  theme?.fontSize?.pageblockSubtitle,
                              }}
                            >
                              {article.content.description}
                            </p>
                  ...
                  return (
                    <div key={article.id} className={classes.article.main}>
                      ...
                      <div>
                        ...
                        >
                          <h3
                            className={classes.content.main.title}
                            style={{
                              fontFamily: theme.title.fontFamily,
                              color: theme.title.color,
                              fontSize:
                        ...
                        {blockConfig.styles.showExcerpt && (
                          <p
                            className={classes.content.main.subtitle}
                            style={{
                              fontFamily: theme.subtitle.fontFamily,
                              color: theme.subtitle.color,
                              fontSize:
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          <h3
                            className={classes.content.sidebar.title}
                            style={{
                              fontFamily: theme.title.fontFamily,
                              color: theme.title.color,
                              fontSize:
                        ...
                        {blockConfig.styles.showExcerpt && (
                          <p
                            className={classes.content.sidebar.subtitle}
                            style={{
                              fontFamily: theme.subtitle.fontFamily,
                              color: theme.subtitle.color,
                              fontSize:
              ...
              : // Row skeleton
                [...Array(5)].map((_, i) => (
                  <div key={i} className={classes.column}>
                    <article
                      className={
                        i === 0 ? classes.mainArticle : classes.secondaryArticle
                      }
                    >
                  ...
                  >
                    <article className="relative">
                      {article.content?.image?.desktop_image_path && (
                        <div className="relative w-full overflow-hidden mb-4">
                          <img
                            src={article.content.image.desktop_image_path}
                            alt={article.title}
                            className={`w-full ${getRandomHeight(
                              article.id
                            )} object-cover`}
                          />
                        </div>
                      ...
                      <div className="p-4 bg-white dark:bg-gray-800 rounded-lg">
                        <h2
                          className="text-[1.2rem] font-semibold mb-3 text-gray-900 dark:text-white"
                          style={{
                            fontFamily: theme.title.fontFamily,
                            color: theme.title.color,
                        ...
                        {blockConfig.styles.showExcerpt && article.subtitle && (
                          <p
                            className="text-[0.9rem] text-gray-700 dark:text-gray-300"
                            style={{
                              fontFamily: theme.subtitle.fontFamily,
                              color: theme.subtitle.color,
                              fontSize:
                    ...
                    {article.content?.image?.desktop_image_path ? (
                      ...
                      >
                        ...
                        `}
                          ...
                          {article.subtitle && (
                            <p
                              className={classes.content.subtitle}
                              style={{
                                fontFamily: theme.subtitle.fontFamily,
                                color: theme.subtitle.color,
                                fontSize:
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        style={{
          backgroundColor:
            blockConfig.layout.styles.backgroundColor ||
            (isDarkTheme
              ? 'rgba(31, 41, 55, 0.5)'
