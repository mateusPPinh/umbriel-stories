...
const Magazine: React.FC<BaseVariantProps> = ({
  variant,
  isDarkTheme,
  customStyles,
  ...
  return (
    <div className={`${classes.container} ${customStyles?.container || ''}`}>
      <div
        className={
          customStyles?.grid || 'grid grid-cols-1 lg:grid-cols-12 gap-6'
        }
      >
        {/* Main Article */}
        {mainArticle && (
          <div className={customStyles?.mainColumn || 'lg:col-span-6'}>
            <article className={customStyles?.mainArticle || 'flex flex-col'}>
              {mainArticle.content?.image?.desktop_image_path && (
                <div
                  className={
                    customStyles?.imageWrapper ||
                    'relative w-full aspect-[16/9] overflow-hidden mb-4'
                  }
                >
                  <img
                    ...
                    className={
                      customStyles?.image || 'w-full h-full object-cover'
                    }
                  />
                </div>
              )}
              ...
              <div className={customStyles?.content || 'p-4'}>
                ...
                >
                  <h2
                    className={
                      customStyles?.heading || 'text-2xl font-bold mb-3'
                    }
                    style={{
                      fontFamily: theme.title.fontFamily,
                      color: theme.title.color,
              ...
              >
                ...
                <div className={customStyles?.content || 'p-4'}>
                  ...
                  >
                    <h2
                      className={
                        customStyles?.heading || 'text-xl font-semibold mb-2'
                      }
                      style={{
                        fontFamily: theme.title.fontFamily,
                        color: theme.title.color,
